...
const LoginPage: React.FC = () => {
    ...
    return (
        <div className="c-page-login-screen">
            {/* Header */}
            <header>
                <div className="c-page-login-h">
                    <div className="c-page-login-h-logo">
                        <div className="bg-blue-600 p-3 rounded-2xl">
                            <Building2 className="w-8 h-8 text-white" />
                        </div>
                    </div>
                    <h1 className="c-page-login-h-h1">RISA ID</h1>
                    <p className="c-page-login-h-p">Sign in to your account</p>
                </div>
            </header>

            {/* Login Form */}
            <div className="c-page-login-body">
                <form onSubmit={handleSubmit} className="c-page-login-body-form">
                    <div>
